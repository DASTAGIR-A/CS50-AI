...
class MinesweeperAI:
    ...
    def update_knowledge(self):
        """
        Updates the AI's knowledge base by marking additional cells
        as safe or as mines if possible, and adding new inferred sentences.
        """
        changed = True
        ...
        while changed:
            ...
            # Try to infer new sentences from existing ones
            new_sentences = []
