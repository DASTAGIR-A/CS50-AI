...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # First, compute probability each parent passes the gene
            passing = {}
            ...
            mom_pass = passing[mother]
            dad_pass = passing[father]

            # Compute gene probability for this person
            if genes == 2:
...
def update(probabilities, one_gene, two_genes, have_trait, p):
    ...
    for person in probabilities:
        if person in two_genes:
            gene_2 = 2
            probabilities[person]["gene"][gene_2] += p
        elif person in one_gene:
            gene_1 = 1
            probabilities[person]["gene"][gene_1] += p
        else:
            gene_0 = 0
            probabilities[person]["gene"][gene_0] += p
        has_trait = person in have_trait
